...
path='C:\\Users\\LAC40641\\Desktop\\red neuronal recurrente\\'
...
# load dataset
dataset = read_csv(path+'salida_metricas_mod_variacion.csv', header=0, index_col=0)

                
for epoca in [30,600,50,1000,150,300]:
    for batch in [10,100,20,100,50,200]:
        for ver in [1,7,3,30,15]:
