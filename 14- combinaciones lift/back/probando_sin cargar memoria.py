...
datos=pd.read_csv('/Users/laiunce/Google Drive/scraping/prueba busqueda lift/dataset4.csv',encoding='latin-1',low_memory=False)
...
filtros = []
for u in lista_combinaciones_gral:
    texto_filtro=''
    for i in u:
...
df_filtered = datos.query(filtros[0])
